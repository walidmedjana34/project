...
<body>
    <div class="password-reset-container">
        ...
        <p>Entrez votre adresse email et nous vous enverrons un code de confirmation pour réinitialiser votre mot de passe.</p>
        ...
        <div class="back-to-login">
            <a href="{{route('home.connexion')}}">Retour à la page de connexion</a>
        </div>
    </div>
